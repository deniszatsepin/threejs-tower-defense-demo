...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		define(['three'], function(THREE, glTFParser) {
			return factory(root, THREE, glTFParser);
		})
	} else {
		factory(root);
	}
			...
			value: function (glType, type) {
				switch (type) {
					case 'SCALAR':
						break;
					case 'VEC2':
						glType = WebGLRenderingContext.FLOAT_VEC2;
						break;
					case 'VEC3':
						glType = WebGLRenderingContext.FLOAT_VEC3;
						break;
					case 'VEC4':
						glType = WebGLRenderingContext.FLOAT_VEC4;
						break;
				}
				switch (glType) {
					...
					default:
						console.warn('[_elementSizeForGLType] doesn\'t exits: ', glType);
						return null;
				}
			}
		},

...
THREEx.Sparks	= function(opts)
{
	...
	for (var i = 0; i < this._maxParticles; i++ ) {
		...
		//var position	= new THREE.Vector3(Math.random() * 10, Math.random() * 10, Math.random() * 10);
	...
	*/
	...
	this._group	= new THREE.PointCloud( particles, material );
    ...
    emitter.addCallback("loopUpdated", onLoopUpdated.bind(this));
}
